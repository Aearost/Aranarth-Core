...
/**
 * Denies a pending (cross-server) teleport request.
 */
public class CommandTpDeny implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String alias, String[] args) {
        ...
        player.sendMessage("§7You have denied §e" + ctx.remotePlayerNickname() + "§7's teleport request");
        net.publishTpDenied(player.getUniqueId(), player.getName(), ctx.remotePlayerUuid());
        return true;
    }
}
