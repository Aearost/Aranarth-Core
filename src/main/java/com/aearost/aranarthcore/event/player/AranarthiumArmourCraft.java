...
public class AranarthiumArmourCraft {
                ...
                // Picking up
                    ...
                    if (slot == 0 || slot == 1) {
                        ...
                        if (armorInFirst || ingotInFirst || netheriteElytraArmorFirst || netheriteElytraIngotFirst) {
                            ...
                            String strippedName = ChatUtils.stripColorFormatting(displayName).toLowerCase();
    ...
    /**
     * Determines if the input slot is a normal netherite armour piece or Netherite Elytra.
     *
        ...
        switch (ingotName) {
            case "aquatic" -> {
                if (type == Material.NETHERITE_HELMET) {
                    ...
                    enhancedAranarthiumArmor = new AquaticAranarthiumElytra().getItem();
                }
            }
            case "ardent" -> {
                if (type == Material.NETHERITE_HELMET) {
                    ...
                    enhancedAranarthiumArmor = new ArdentAranarthiumElytra().getItem();
                }
            }
            case "dwarven" -> {
                if (type == Material.NETHERITE_HELMET) {
                    ...
                    enhancedAranarthiumArmor = new DwarvenAranarthiumElytra().getItem();
                }
            }
            case "elven" -> {
                if (type == Material.NETHERITE_HELMET) {
                    ...
                    enhancedAranarthiumArmor = new ElvenAranarthiumElytra().getItem();
                }
            }
            case "scorched" -> {
                if (type == Material.NETHERITE_HELMET) {
                    ...
                    enhancedAranarthiumArmor = new ScorchedAranarthiumElytra().getItem();
                }
            }
            case "soulbound" -> {
                if (type == Material.NETHERITE_HELMET) {
                    ...
                    enhancedAranarthiumArmor = new SoulboundAranarthiumElytra().getItem();
                }
            }
            case "fae" -> {
                if (type == Material.NETHERITE_HELMET) {
                    ...
                    enhancedAranarthiumArmor = new FaeAranarthiumElytra().getItem();
                }
            }
        }
        ...
        for (Enchantment enchantment : enchantments.keySet()) {
            if (enhancedAranarthiumArmor.containsEnchantment(enchantment)) {
                ...
                if (aranarthiumEnchantmentLevel > armorLevel) {
                    ...
                    resultMeta.addEnchant(enchantment, aranarthiumEnchantmentLevel, true);
