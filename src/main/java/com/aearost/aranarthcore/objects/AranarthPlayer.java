...
public class AranarthPlayer {
    ...
    private int crateSoundVolume = 100;
    private int weatherSoundVolume = 100;
    private int newDaySoundVolume = 100;
    private int newMonthSoundVolume = 100;
    private int privateMsgSoundVolume = 100;
    private int teleportSoundVolume = 100;
    private int avatarSoundVolume = 100;
    private int dominionSoundVolume = 100;
    private int aranarthiumSoundVolume = 100;
    private int chatGameSoundVolume = 100;
    ...
    public double getSurvivalHealth() {
        return survivalHealth;
    }

    public void setSurvivalHealth(double survivalHealth) {
        this.survivalHealth = survivalHealth;
    }

    public int getSurvivalFoodLevel() {
        return survivalFoodLevel;
    }

    public void setSurvivalFoodLevel(int survivalFoodLevel) {
        this.survivalFoodLevel = survivalFoodLevel;
    }

    public float getSurvivalSaturation() {
        return survivalSaturation;
    }

    public void setSurvivalSaturation(float survivalSaturation) {
        this.survivalSaturation = survivalSaturation;
    }

    public int getSurvivalExpLevel() {
        return survivalExpLevel;
    }

    public void setSurvivalExpLevel(int survivalExpLevel) {
        this.survivalExpLevel = survivalExpLevel;
    }

    public float getSurvivalExpProgress() {
        return survivalExpProgress;
    }

    public void setSurvivalExpProgress(float survivalExpProgress) {
        this.survivalExpProgress = survivalExpProgress;
    }
    ...
    public void setJoinSoundVolume(int joinSoundVolume) {
        this.joinSoundVolume = joinSoundVolume;
    }

    public int getLeaveSoundVolume() {
        return leaveSoundVolume;
    }

    public void setLeaveSoundVolume(int leaveSoundVolume) {
        this.leaveSoundVolume = leaveSoundVolume;
    }

    public int getVoteSoundVolume() {
        return voteSoundVolume;
    }

    public void setVoteSoundVolume(int voteSoundVolume) {
        this.voteSoundVolume = voteSoundVolume;
    }

    public int getCrateSoundVolume() {
        return crateSoundVolume;
    }

    public void setCrateSoundVolume(int crateSoundVolume) {
        this.crateSoundVolume = crateSoundVolume;
    }

    public int getWeatherSoundVolume() {
        return weatherSoundVolume;
    }

    public void setWeatherSoundVolume(int weatherSoundVolume) {
        this.weatherSoundVolume = weatherSoundVolume;
    }

    public int getNewDaySoundVolume() {
        return newDaySoundVolume;
    }

    public void setNewDaySoundVolume(int newDaySoundVolume) {
        this.newDaySoundVolume = newDaySoundVolume;
    }

    public int getNewMonthSoundVolume() {
        return newMonthSoundVolume;
    }

    public void setNewMonthSoundVolume(int newMonthSoundVolume) {
        this.newMonthSoundVolume = newMonthSoundVolume;
    }

    public int getPrivateMsgSoundVolume() {
        return privateMsgSoundVolume;
    }

    public void setPrivateMsgSoundVolume(int privateMsgSoundVolume) {
        this.privateMsgSoundVolume = privateMsgSoundVolume;
    }
    ...
    public void setTeleportSoundVolume(int teleportSoundVolume) {
        this.teleportSoundVolume = teleportSoundVolume;
    }

    public int getAvatarSoundVolume() {
        return avatarSoundVolume;
    }

    public void setAvatarSoundVolume(int avatarSoundVolume) {
        this.avatarSoundVolume = avatarSoundVolume;
    }

    public int getDominionSoundVolume() {
        return dominionSoundVolume;
    }

    public void setDominionSoundVolume(int dominionSoundVolume) {
        this.dominionSoundVolume = dominionSoundVolume;
    }

    public int getAranarthiumSoundVolume() {
        return aranarthiumSoundVolume;
    }

    public void setAranarthiumSoundVolume(int aranarthiumSoundVolume) {
        this.aranarthiumSoundVolume = aranarthiumSoundVolume;
    }

    public int getChatGameSoundVolume() {
        return chatGameSoundVolume;
    }

    public void setChatGameSoundVolume(int chatGameSoundVolume) {
        this.chatGameSoundVolume = chatGameSoundVolume;
    }

    public int getChestSortSoundVolume() {
        return chestSortSoundVolume;
    }

    public void setChestSortSoundVolume(int chestSortSoundVolume) {
        this.chestSortSoundVolume = chestSortSoundVolume;
    }

    public int getJobsSoundVolume() {
        return jobsSoundVolume;
    }

    public void setJobsSoundVolume(int jobsSoundVolume) {
        this.jobsSoundVolume = jobsSoundVolume;
    }

    public int getExpStoreSoundVolume() {
        return expStoreSoundVolume;
    }
