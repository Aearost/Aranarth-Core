...
public class LavaGlaives extends LavaAbility implements AddonAbility {
    ...
    private static final Map<UUID, LavaGlaives> activeInstances = new HashMap<>();
    ...
    public LavaGlaives(Player player) {
        super(player);
    ...
    public static LavaGlaives getActiveInstance(UUID uuid) {
    ...
    public String getDescription() {
        return "Forge two spinning glaives of molten rock by channeling your lavabending. " +
                "Hold sneak until the block forms into magma, and release to deploy the glaives at your sides. " +
                "Left-click to hurl each glaive in the direction you are looking, slightly knocking back your targets.";
    }
}
