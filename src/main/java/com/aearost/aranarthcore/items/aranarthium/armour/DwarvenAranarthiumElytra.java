...
public class DwarvenAranarthiumElytra implements AranarthItem {

    public ItemStack getItem() {
        ItemStack item = new ItemStack(Material.ELYTRA, 1);
        ItemMeta meta = item.getItemMeta();
        if (Objects.nonNull(meta)) {
            NamespacedKey key = new NamespacedKey(AranarthCore.getInstance(), "aranarthium_dwarven_elytra");
            ...
            meta.addAttributeModifier(Attribute.ARMOR,
                    new AttributeModifier(new NamespacedKey(AranarthCore.getInstance(), "dwarven_elytra_armor"),
                            8.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.CHEST));
            meta.addAttributeModifier(Attribute.ARMOR_TOUGHNESS,
                    new AttributeModifier(new NamespacedKey(AranarthCore.getInstance(), "dwarven_elytra_toughness"),
            ...
            meta.addAttributeModifier(Attribute.KNOCKBACK_RESISTANCE,
                    new AttributeModifier(new NamespacedKey(AranarthCore.getInstance(), "dwarven_elytra_knockback"),
    ...
    public String getName() {
        return "&#FFEE8C&lDwarven Aranarthium Elytra";
    }
