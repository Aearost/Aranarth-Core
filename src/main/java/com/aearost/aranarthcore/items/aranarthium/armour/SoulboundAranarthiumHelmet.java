 ...
 */
public class SoulboundAranarthiumHelmet implements AranarthItem {

	/**
	 * @return The Soulbound Aranarthium Helmet.
	 */
	...
	public String getName() {
		return ChatUtils.translateToColor("#9400D3&lSoulbound Aranarthium Helmet");
	}
