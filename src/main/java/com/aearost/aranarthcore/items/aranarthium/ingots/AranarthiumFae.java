...
/**
 * Provides the necessary components of a Fae Aranarthium Ingot item.
 */
public class AranarthiumFae implements AranarthItem {
	...
	public ItemStack getItem() {
		...
		if (Objects.nonNull(meta)) {
			...
			meta.getPersistentDataContainer().set(ARANARTHIUM_INGOT, PersistentDataType.STRING, "fae");
