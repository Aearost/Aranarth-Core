...
/**
 * Provides the necessary components of a Scorched Aranarthium Chestplate item.
 */
public class ScorchedAranarthiumChestplate implements AranarthItem {

	/**
	 * @return The Scorched Aranarthium Chestplate.
	 */
	public ItemStack getItem() {
		ItemStack item = new ItemStack(Material.NETHERITE_CHESTPLATE, 1);
		ArmorMeta meta = (ArmorMeta) item.getItemMeta();
		if (Objects.nonNull(meta)) {
//			NamespacedKey key = new NamespacedKey(AranarthCore.getInstance(), "aranarthium_scorched_chestplate");
