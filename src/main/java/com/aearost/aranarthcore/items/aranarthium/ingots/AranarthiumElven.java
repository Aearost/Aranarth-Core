...
public class AranarthiumElven implements AranarthItem {
	...
	public ItemStack getItem() {
		...
		if (Objects.nonNull(meta)) {
			NamespacedKey key = new NamespacedKey(AranarthCore.getInstance(), "aranarthium_elven");
			meta.setItemModel(key);
			ArrayList<String> lore = new ArrayList<>();
			meta.getPersistentDataContainer().set(ARANARTHIUM_INGOT, PersistentDataType.STRING, "elven");
	...
	public String getName() {
		return "&#3F704D&lElven Aranarthium";
	}
