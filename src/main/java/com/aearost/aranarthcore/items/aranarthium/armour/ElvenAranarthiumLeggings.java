...
/**
 * Provides the necessary components of an Elven Aranarthium Leggings item.
 */
public class ElvenAranarthiumLeggings implements AranarthItem {

	/**
	 * @return The Elven Aranarthium Leggings.
	 */
	...
	public String getName() {
		return "&#3F704D&lElven Aranarthium Leggings";
	}
