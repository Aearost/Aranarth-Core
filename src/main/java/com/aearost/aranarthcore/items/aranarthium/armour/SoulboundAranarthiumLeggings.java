 ...
 */
public class SoulboundAranarthiumLeggings implements AranarthItem {

	/**
	 * @return The Soulbound Aranarthium Leggings.
	 */
	public ItemStack getItem() {
		ItemStack item = new ItemStack(Material.NETHERITE_LEGGINGS, 1);
		ArmorMeta meta = (ArmorMeta) item.getItemMeta();
		if (Objects.nonNull(meta)) {
			NamespacedKey key = new NamespacedKey(AranarthCore.getInstance(), "aranarthium_soulbound_leggings");
	...
	public String getName() {
		return ChatUtils.translateToColor("#9400D3&lSoulbound Aranarthium Leggings");
	}
