...
public class CommandRules implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String alias, String[] args) {
		...
		sender.sendMessage(ChatUtils.translateToColor("&8[&62&8] &7Do not spam chat or intentionally disrupt it with excessive caps, flooding, or similar behavior."));
		...
		sender.sendMessage(ChatUtils.translateToColor("&8[&68&8] &7Only client-side mods approved by the Council (staff) are permitted (i.e OptiFine, Shaders, MiniHUD, etc)."));
		...
		sender.sendMessage(ChatUtils.translateToColor("&8[&610&8] &7Small-scaled automatic crop, mob, and spawner farms are permitted with prior Council approval. Large-scaled farms are not."));
		return true;
	}
